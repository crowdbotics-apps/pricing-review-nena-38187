...
## Project Structure
    ...
    ├── pricing_review_nena_38187  # Django project configurations
...
1. Clone this repo and `cd pricing_review_nena_38187`
...
2. Clone this repo and `cd pricing_review_nena_38187`
